...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let answer = arr.reduce((stuff, val, idx) => {
    if(idx > stuff){
      stuff = idx;
    }
    return stuff;
...
const returnNames = (arr) => {
  // Solution code here...
  let names = arr.reduce((previous, current) => {
...
const reversedString = (str) => {
  // Solution code here...
  let stuff = str.split('');
  return stuff.reduce((accumulator, currentValue) => currentValue + accumulator);
  // let answer = stuff.reduce((accumulator, currentValue) => {
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  let numKids = arr.reduce((total, char) => {
    try{
...
const countPrimeNumbers = (arr) => {
  // Solution code here...
  let numPrime = arr.reduce((accum, val) => {
    console.log(`accum is ${accum} val is ${val} test is ${isPrime(val)}`);
    if(isPrime(val)){
      accum++
      return accum;
    } else {
